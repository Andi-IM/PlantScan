...
interface DataModule {
    @Binds
    fun provideRemoteDataSource(dataSource: FirestoreSourceImpl): FirestoreSource
    @Binds
    fun provideRepository(repositoryImpl: PlantRepositoryImpl): PlantRepository
    @Binds
    fun provideCameraRepository(repositoryImpl: CameraRepositoryImpl): CameraRepository
}
