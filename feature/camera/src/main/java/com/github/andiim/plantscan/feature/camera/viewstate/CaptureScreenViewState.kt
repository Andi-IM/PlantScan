...
package com.github.andiim.plantscan.feature.camera.viewstate

/**
 * Capture Screen is the top level view state. A capture screen contains a camera preview screen and
 * a post capture screen.
 */
