...
import com.github.andiim.plantscan.core.firestore.firebase_services.LogService
...
constructor(
    ...
    log: com.github.andiim.plantscan.core.firestore.firebase_services.LogService
) : com.github.andiim.plantscan.core.crashlytics.PlantScanViewModel() {
  ...
  fun capturePhoto() {
    ...
    val photoFile = repository.createImageOutputFile()
    val metadata =
    ...
    imageCapture.takePicture(
        ...
        object : ImageCapture.OnImageSavedCallback {
          override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
            repository.notifyImageCreated(outputFileResults.savedUri ?: photoFile.toUri())
