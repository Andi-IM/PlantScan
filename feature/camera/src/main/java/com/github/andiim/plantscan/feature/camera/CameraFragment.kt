...
import com.github.andiim.plantscan.feature.camera.adapter.CameraExtensionItem
...
import com.github.andiim.plantscan.feature.camera.model.PermissionState
import com.github.andiim.plantscan.feature.camera.ui.doOnLaidOut
...
import com.github.andiim.plantscan.feature.camera.ui.CameraExtensionsScreen
...
class CameraFragment : Fragment() {
  ...
  var toDetectScreen: ((String) -> Unit)? = null
      ...
      extensionsScreen.action.collectLatest { action ->
        when (action) {
          ...
          is CameraUiAction.ActionDetect -> {
            val uri = action.uri
            toDetectScreen?.invoke("detectRoute/$uri")
          }
