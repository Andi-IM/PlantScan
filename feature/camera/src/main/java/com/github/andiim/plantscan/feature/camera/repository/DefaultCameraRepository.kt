package com.github.andiim.plantscan.feature.camera.repository
...
import com.github.andiim.plantscan.core.data.R
 ...
 */
@Singleton
class DefaultCameraRepository @Inject constructor(@ApplicationContext context: Context) :
    CameraRepository {
