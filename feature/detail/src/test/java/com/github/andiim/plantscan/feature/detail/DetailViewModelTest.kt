...
import com.github.andiim.plantscan.core.common.Resource
...
class DetailViewModelTest {
  ...
  @Mock private lateinit var useCase: com.github.andiim.plantscan.domain.PlantUseCase
  ...
  fun `getDetail sets uiState correctly`() = runTest {
    val plantId = "123"
    val fakePlant = com.github.andiim.plantscan.model.data.Plant(id = plantId, name = "Plant A")
    val fakeResource = com.github.andiim.plantscan.core.common.Resource.Success(fakePlant)
  ...
  fun `setPlantToGarden calls addPlantToGarden and updates isSaved`() = runTest {
    val fakePlant = com.github.andiim.plantscan.model.data.Plant(id = "123", name = "Plant A")
